...
[$num, $qh] = getDailyTimes($month, $day, $year, $contextUser, $proj_id);
				...
				<table width="100%" border="0">
					<tr>
						<td align="left" nowrap class="outer_table_heading" nowrap>
							<?php echo _TSX_TS_DAYTS ?>
						</td>
						<td align="left" nowrap class="outer_table_heading">
							<?php echo strftime('%A %B %d, %Y', mktime(0, 0, 0, $month, $day, $year)); ?>
						</td>
						<td align="right" nowrap>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?month=<?php echo date('m', $yesterday); ?>&year=<?php echo date('Y', $yesterday); ?>&day=<?php echo date('d', $yesterday); ?>&proj_id=<?php echo $proj_id; ?>" class="outer_table_action"><?php echo _TSX_GEN_PREV ?></a>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?month=<?php echo date('m', $tomorrow); ?>&year=<?php echo date('Y', $tomorrow); ?>&day=<?php echo date('d', $tomorrow); ?>&proj_id=<?php echo $proj_id; ?>" class="outer_table_action"><?php echo _TSX_GEN_NEXT ?></a>
						</td>
					</tr>
				</table>
			...
			<td>			
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_body">
					<tr class="inner_table_head">
						<td class="inner_table_column_heading" align="center"><?echo _TSX_TS_PROJ ?></td>
						<td class="inner_table_column_heading" align="center"><?echo _TSX_TS_TASK ?></td>
						<td class="inner_table_column_heading" align="center"><?echo _TSX_TS_START ?></td>
						<td class="inner_table_column_heading" align="center"><?echo _TSX_TS_END ?></td>
						<td class="inner_table_column_heading" align="center"><?echo _TSX_TS_TOTAL ?></td>
						<td class="inner_table_column_heading" align="center"><i><?echo _TSX_GEN_ACT ?></i></td>
					</tr>
<?php
if (0 == $num) {
    print "	<tr>\n";
...
<?php include 'timesheet_face_part_1.inc'; ?>			
				...
				<table width="100%" border="0">
					<tr>
						<td align="left" nowrap class="outer_table_heading" nowrap>
							<?php echo _TSX_TS_UPCLOCKON ?> / <?php echo _TSX_TS_UPOFF ?>
						</td>
					</tr>
				</table>
							...
							<table width="100%" border="0">
								<tr>
									<td align="left" width="100%" nowrap>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td><table width="50"><tr><td><?echo _TSX_TS_CLIENT ?>: </td></tr></table></td>
													<td width="100%">
								...
								<tr>
									<td align="left" width="100%" nowrap>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td><table width="50"><tr><td><?echo _TSX_TS_PROJ ?>:</td></tr></table></td>
													<td width="100%">
								...
								<tr>
									<td align="left" width="100%">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td><table width="50"><tr><td><?echo _TSX_TS_TASK ?>:</td></tr></table></td>
													<td width="100%">
													...
													<table width="300" border="0" class="clock_on_box">
														<tr>										
															<td valign="top" align="left" class="clock_on_text">
																<input type="checkbox" name="clock_on_check" id="clock_on_check" onclick="enableClockOn();"><?php echo _TSX_TS_CLOCKONAT ?>:
															</td>
															<td valign="middle">
													...
													<table width="300" border="0" class="clock_off_box">
														<tr>
															<td valign="top" align="left" class="clock_off_text">
																<input type="checkbox" name="clock_off_check" id="clock_off_check" onclick="enableClockOff();"><?php echo _TSX_TS_CLOCKOFFAT ?>:
															</td>
															<td valign="middle">
																<?php // If the current day is today:
                                                                if (($year == date('Y')) && ($month == date('m')) && ($day == date('j'))): ?>
