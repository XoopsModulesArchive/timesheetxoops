<?php
//$Header: /cvsroot/tsheet/timesheet.php/index.php,v 1.9 2005/05/23 05:39:38 vexil Exp $
...
if (0 != $proj_id) { // id 0 means 'All Projects'
...
function print_totals($seconds, $type, $year, $month, $day)
{
    ...
    // Called from index.php to print out a line summing the hours worked in the past
    ...
    if ('monthly' == $type) {
        print _TSX_TS_MTHTOTAL . ': ';
    } else {
        print "<a href=\"weekly.php?client_id=$client_id&proj_id=$proj_id&task_id=$task_id&year=$year&month=$month&day=$day\">" . _TSX_TS_WKTOTAL . ': </a>';
    }
...
<title>Timesheet for <?php echo (string)$contextUser ?></title>
<?php
include('header.inc');
?>
<!-- </head> -->
				...
				<table width="100%" border="0">
					<tr>
								...
								<tr>
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td height="1"></td>
												<td height="1"><img src="modules/timesheetxoopsimages/spacer.gif" width="150" height="1"></td>
											</tr>											
										</table>
									</td>	
									<td>		
						...
						<td align="right" nowrap>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?client_id=<?php echo $client_id; ?>&proj_id=<?php echo $proj_id; ?>&task_id=<?php echo $task_id; ?>&year=<?php echo $last_year ?>&month=<?php echo $last_month ?>&day=<?php echo $todayDay; ?>" class="outer_table_action"><?echo _TSX_GEN_PREV?></a>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?client_id=<?php echo $client_id; ?>&proj_id=<?php echo $proj_id; ?>&task_id=<?php echo $task_id; ?>&year=<?php echo $next_year ?>&month=<?php echo $next_month ?>&day=<?php echo $todayDay; ?>" class="outer_table_action"><?echo _TSX_GEN_NEXT?></a>
						</td>
					</tr>
				</table>
...
<?php {
    ...
    [$num, $qh] = get_time_date($month, $year, $contextUser, $proj_id, $client_id);
  ...
  while (checkdate($month, $day, $year)) {
      ...
      if ((0 == ($dayRow % 7)) && (0 != $dowForFirstOfMonth)) {
      ...
      for ($i = 0; $i < $num; $i++) {
          ...
          if (
              ...
              if (0 == $client_id && $last_client_id != $data['client_id']) {
              ...
              if (0 == $proj_id && $last_proj_id != $data['proj_id']) {
