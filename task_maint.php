...
<script language="Javascript">
	...
	function delete_task(projectId, taskId) {
				if (confirm('<?echo _TSX_TASK_CONF_DELETE ?>'))
				...
				<table width="100%" border="0">
					<tr>
							...
							<table width="100%" height="100%" border="0" cellpadding="1" cellspacing="2">
								<tr>
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><table width="50"><tr><td><?echo _TSX_TASK_CLIENT ?>:</td></tr></table></td>
									...
									<td>		
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><table width="50"><tr><td><?echo _TSX_TASK_PROJ ?>:</td></tr></table></td>
						...
						<td align="center" class="outer_table_heading" nowrap>
							<?echo _TSX_TASK_TITLE ?></td>
						</td>
						<td align="right" nowrap>
                            <?php if ($proj_id != 0) { ?>
							<a href="task_add.php?proj_id=<?php echo $proj_id; ?>"><?echo _TSX_TASK_ADD_TASK ?></a>
                            <?php } else { ?>
								<span class="disabledLink"><?echo _TSX_TASK_ADD_TASK ?></span>
                            <?php } ?>
						</td>
					</tr>
				</table>
...
<!-- include the timesheet face up until the heading start section -->
				...
				<tr>
					<td>					
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_body">
                            <?php
	//execute query
	[$qh_task, $num_task] = dbQuery($query_task);
	...
	if ($num_task == 0) {    
		if ($proj_id == 0) {
			...
			print '			<i><br>' . _TSX_TASK_SEL_CLWP . ".<br><br></i>\n";
			print "		</td>\n";
			print "	</tr>\n";		
		}
		else {
			print "	<tr>\n";
			print "		<td align=\"center\">\n";
			print '			<i><br>' . _TSX_TASK_NTFP . "<br><br></i>\n";
			print "		</td>\n";
			print "	</tr>\n";
		}
	}
				...
				<table width="100%" border="0"<?php if ($j + 1 < $num_task) print 'class="section_body"'; ?>>
					<tr>
						...
						<td align="right" valign="top" nowrap>
							...
							<a href="task_edit.php?task_id=<?php echo $data_task['task_id']; ?>"><?echo _TSX_GEN_EDIT?></a>,
							<a href="javascript:delete_task(<?php echo $proj_id; ?>,<?php echo $data_task['task_id']; ?>);"><?echo _TSX_GEN_DEL?></a>
						</td>
					</tr>
					<tr>
						<td align="left" colspan="2" align="top">
							<span class="label"><?echo _TSX_TASK_LBL_AU ?></span><br>
<?php
			//get assigned users
			[$qh3, $num_3] = dbQuery("select username, task_id from $TASK_ASSIGNMENTS_TABLE where task_id=$data_task[task_id]");
			if ($num_3 > 0) {
