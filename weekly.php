...
if (0 != $proj_id && 0 != $client_id) { // id 0 means 'All Projects'
...
} elseif ($client_id > 0) { //only records for projects of the given client
...
<title>Weekly Timesheet for <?php echo (string)$contextUser ?></title>
<?php
include('header.inc');
?>
<!-- </head> -->
				...
				<table width="100%" border="0">
					<tr>
						...
						<td align="right" nowrap>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?proj_id=<?echo $proj_id; ?>&task_id=<?php echo $task_id; ?>&year=<?echo $previousWeekYear ?>&month=<?php echo $previousWeekMonth ?>&day=<?php echo $previousWeekDay ?>" class="outer_table_action"> <?php echo _TSX_GEN_PREV ?> </a>
							<a href="<?php echo $_SERVER['PHP_SELF']; ?>?proj_id=<?php echo $proj_id; ?>&task_id=<?php echo $task_id; ?>&year=<?php echo $nextWeekYear ?>&month=<?php echo $nextWeekMonth ?>&day=<?php echo $nextWeekDay ?>" class="outer_table_action"><?php echo _TSX_GEN_NEXT ?> </a>
						</td>
					</tr>
				</table>
...
<?php
    ...
    class TaskInfo extends Pair
    {
        ...
        public function __construct($value1, $value2, $projectId, $projectTitle, $taskName, $clientName)
        {
    ...
    for ($i = 0; $i < $num3; $i++) {
        ...
        for ($k = 0; $k < 7; $k++) {
            ...
            elseif ($startsOnPreviousDay && $endsToday) {
            ...
            elseif ($startsToday && $endsOnFollowingDay) {
